package com.lewis.daiosi.diaosicheng.movie;
...
import com.lewis.daiosi.diaosicheng.media.IjkVideoView;
...
//    private OrientationEventListener orientationEventListener;
    ...
    private void initViews() {
        ...
        rView = View.inflate(mContext,R.layout.view_video_item,null);
        view = rView.findViewById(R.id.media_contoller);
        mVideoView = (IjkVideoView)rView. findViewById(R.id.main_video);
