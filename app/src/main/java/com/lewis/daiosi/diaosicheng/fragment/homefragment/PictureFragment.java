...
import com.lewis.daiosi.diaosicheng.view.cardview.flingswipe.SwipeFlingAdapterView;
import com.lewis.daiosi.diaosicheng.view.cardview.swipecards.CardAdapter;
import com.lewis.daiosi.diaosicheng.view.cardview.swipecards.CardMode;
...
public class PictureFragment extends BaseFragment {
    ...
    public void initView(View view) {
        ...
        adapter = new CardAdapter(getContext(), al);
        ...
        flingContainer.setFlingListener(new SwipeFlingAdapterView.onFlingListener() {
            ...
            public void onLeftCardExit(Object dataObject) {
                makeToast(getContext(), "不喜欢");
            }

            @Override
            public void onRightCardExit(Object dataObject) {
                makeToast(getContext(), "喜欢");
            }
